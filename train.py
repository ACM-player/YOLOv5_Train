...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='configs/yolov5-Improved/yolo_hornet_s_backbone.yaml', help='model.yaml path')
    ...
    parser.add_argument('--batch-size', type=int, default=32, help='face_mask batch size for all GPUs, -1 for autobatch')
